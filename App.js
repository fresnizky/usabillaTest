...
const appId = '91ce2c24-2150-48e6-9e56-77f8991b15a4';
// Replace FormId with your usabilla form id.
const formId = '62cf2d728ec6d724a8511b2f';
...
export default class App extends Component<{}> {
  constructor() {
    ...
    usabilla.setFormDidFailLoading(reminder =>
      console.log('Error loading form: ', reminder),
    );
    usabilla.setFormDidClose(reminder => {
      isFormVisible = false;
      console.log('Form closed: ', reminder);
    });
    usabilla.setCampaignDidClose(reminder =>
      console.log('Campaign closed: ', JSON.stringify(reminder)),
    );
  }
          ...
          <ImageBackground source={bgImage} style={styles.backgroundImage}>
            ...
            <View style={styles.middle}>
              <View style={styles.showForm}>
                <TouchableWithoutFeedback
                  onPress={this.requestFormWithDefaultScreenshot}>
              ...
              <View style={styles.event}>
                ...
                <TouchableWithoutFeedback
                  onPress={() => this.sendEvent(this.state.text)}>
